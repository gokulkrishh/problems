import checkBookBalancing from './';

describe('Checkbook Balancing', () => {
	it('should return expected result for giving input without special characters', () => {
		expect(
      checkBookBalancing(`1000.00
...
128 Book 14.32
129 Gasoline 16.10`)
		).toEqual(`Original Balance: 1000.00\r
...
Average expense  39.65`);
	...
	it('should return expected result for giving input with special characters', () => {
		expect(
			checkBookBalancing(`1233.00
125 Hardware;! 24.8?;
123 Flowers 93.5
127 Meat 120.90
120 Picture 34.00
...
129 Market;! 128.00?;
121 Gasoline;! 13.6?;`)
		).toEqual(`Original Balance: 1233.00\r
